...
- Police : Quicksand (Google Fonts, OFL), embarquee dans le .pptx (voir fontembed.py). Jamais de serif.
...
recommendations, audit, closing, dashboard, summary, report-cover, performance, analysis.
